...
**פרויקט לקורס פיתוח צד לקוח באנדרואיד**

מערכת ממוחשבת לניהול מתחם אימונים למחלקת נוער באגודת כדורסל.האפליקציה מאפשרת ניהול יעיל של לוחות זמנים, מגרשים וקבוצות בצורה ויזואלית ואינטואיטיבית.
...
```
📁 com.example.testapp/├── 📁 models/           # Data models│   ├── User.java│   ├── Team.java│   ├── Court.java│   ├── DaySchedule.java│   ├── Training.java│   ├── TimeSlot.java    # NEW!│   └── Player.java│├── 📁 fragments/        # UI Fragments│   ├── HomeFragment.java│   ├── TeamsFragment.java│   ├── CourtsFragment.java│   ├── ScheduleFragment.java│   ├── ScheduleGridFragment.java    # NEW!│   ├── AllCourtsViewFragment.java│   ├── ManageUsersFragment.java│   └── PlayerDetailsFragment.java│├── 📁 repository/       # Data layer│   ├── UserRepository.java│   ├── TeamRepository.java│   ├── CourtRepository.java│   └── TrainingRepository.java│├── 📁 viewmodel/        # Business logic│   ├── TeamViewModel.java│   ├── CourtViewModel.java│   └── TrainingViewModel.java│├── 📁 adapters/         # RecyclerView adapters│   ├── TeamAdapter.java│   ├── CourtAdapter.java│   ├── CourtScheduleAdapter.java    # NEW!│   └── TrainingAdapter.java│├── 📁 utils/            # Helper classes│   ├── DateUtils.java│   ├── ColorUtils.java│   ├── Constants.java│   └── TimeSlotUtils.java│└── 📁 Activities        # UI screens    ├── LoginActivity.java    ├── RegisterActivity.java    ├── MainActivity.java    ├── TeamsActivity.java    ├── CourtsActivity.java    ├── ScheduleActivity.java    └── AllCourtsViewActivity.java
```
...
```gradle
// Firebaseimplementation platform('com.google.firebase:firebase-bom:32.7.0')implementation 'com.google.firebase:firebase-database'implementation 'com.google.firebase:firebase-auth'// AndroidXimplementation 'androidx.lifecycle:lifecycle-viewmodel:2.6.2'implementation 'androidx.lifecycle:lifecycle-livedata:2.6.2'implementation 'androidx.recyclerview:recyclerview:1.3.2'// Material Designimplementation 'com.google.android.material:material:1.11.0'
```
...
```
basketball-training-mgmt/├── users/│   └── {userId}/│       ├── name│       ├── email│       ├── role│       └── phone│├── teams/│   └── {teamId}/│       ├── name│       ├── ageGroup│       ├── level│       ├── coachId│       └── color│├── courts/│   └── {courtId}/│       ├── name│       ├── location│       ├── openingHour│       └── closingHour│└── trainings/    └── {trainingId}/        ├── teamId        ├── courtId        ├── dayOfWeek        ├── startTime        └── endTime
```
...
```bash
# הרצת כל הבדיקות./gradlew connectedAndroidTest# הרצת בדיקה ספציפית./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=com.example.testapp.NavigationTests
```
...
**שלו עוזרי**  
שנת לימודים: 2026  
**קורס: פיתוח צד לקוח באנדרואיד**

📧 Email: [shalevozeri951@gmail.com](mailto:shalevozeri951@gmail.com)  
🔗 LinkedIn: [https://www.linkedin.com/in/shalev-shalom-ozeri-786182355](https://www.linkedin.com/in/shalev-shalom-ozeri-786182355)  
💻 GitHub: [https://github.com/ShalevOzeri](https://github.com/ShalevOzeri)
...
© 2026 שלו עוזרי. All rights reserved.
...
1.  צור class חדש שיורש מ-Fragment
2.  הוסף layout XML מתאים
3.  הוסף את ה-Fragment ל-nav_graph.xml
4.  צור navigation action במקום הנדרש
